...
.then(function(episode) {
    resultList.insertAdjacentHTML('beforeend', '<li>' + "Name: " + episode.name + '</li>' +
        '<li>' + "Season: " + episode.season + '</li>' +
        '<li>' + "Number: " + episode.number + '</li>' +
        '<li>' + "Rating: " + episode.rating.average + '</li>' +
        '<li>' + "Airdate: " + episode.airdate + '</li>' +
        '<li>' + "Runtime: " + episode.runtime + '</li>');//sends general episode information to episode.html
        ...
        resultList.insertAdjacentHTML('beforeend', '<li>' + "Desctiption: <br>" + episode.summary + '</li>');//sends the episode description to episode.html
    });
