...
try{resultIMG.insertAdjacentHTML('beforeend', '<li><img src="' + value.image.medium + '" class="imgone" alt="Image of person"></li>')} catch(Typeerror){console.log("person image not found")}
})//Sends the person's image back to person.html
